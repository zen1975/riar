...
This subdirectory is a fully English version of the training package for spotting plausible but incorrect AI answers.
...
- `scripts/eval_persistence.py`
  - Fails when the assistant drops training labels without the explicit control command `plain answer`.
